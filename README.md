...
- **Full-Text Search** - Built-in inverted index with TF-IDF and BM25, no external dependencies
...
- ✅ **Full-Text Search** - Built-in inverted index with TF-IDF and BM25 scoring
