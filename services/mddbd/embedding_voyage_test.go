...
func TestVoyageEmbeddingProvider_New(t *testing.T) {
	p := NewVoyageEmbeddingProvider("vo-test", "https://api.voyageai.com/v1", "voyage-3", 1024)
	if p.Model() != "voyage-3" {
...
func TestVoyageEmbeddingProvider_Embed(t *testing.T) {
	...
	p := NewVoyageEmbeddingProvider("vo-test", server.URL, "voyage-3", 3)
...
func TestVoyageEmbeddingProvider_EmbedBatch(t *testing.T) {
	...
	p := NewVoyageEmbeddingProvider("vo-test", server.URL, "model", 2)
...
func TestVoyageEmbeddingProvider_EmbedAPIError(t *testing.T) {
	...
	p := NewVoyageEmbeddingProvider("bad-key", server.URL, "model", 2)
...
func TestVoyageEmbeddingProvider_EmbedBatchOrdering(t *testing.T) {
	...
	p := NewVoyageEmbeddingProvider("vo-test", server.URL, "model", 1)
