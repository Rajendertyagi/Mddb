...
func (s *Server) handleEndpoints(w http.ResponseWriter, r *http.Request) {
	...
	httpEndpoints := []HTTPEndpoint{
		...
		// Batch operations
		{Method: "POST", Path: "/v1/add-batch", Description: "Batch add documents", RequiresAuth: authEnabled},
		{Method: "POST", Path: "/v1/delete-batch", Description: "Batch delete documents", RequiresAuth: authEnabled},
		{Method: "POST", Path: "/v1/update-batch", Description: "Batch update documents", RequiresAuth: authEnabled},
		...
		{Method: "POST", Path: "/v1/fts", Description: "Full-text search", RequiresAuth: authEnabled},
	...
	grpcMethods := []GRPCMethod{
		...
		{Name: "Delete", Description: "Delete document"},
	...
	mcpTools := []MCPTool{
		...
		{Name: "full_text_search", Description: "Full-text search"},
