...
func TestOpenAIEmbeddingProvider_New(t *testing.T) {
	p := NewOpenAIEmbeddingProvider("sk-test", "https://api.openai.com/v1", "text-embedding-3-small", 1536)
...
func TestOpenAIEmbeddingProvider_Embed(t *testing.T) {
	...
	p := NewOpenAIEmbeddingProvider("sk-test", server.URL, "text-embedding-3-small", 3)
...
func TestOpenAIEmbeddingProvider_EmbedBatch(t *testing.T) {
	...
	p := NewOpenAIEmbeddingProvider("sk-test", server.URL, "model", 2)
...
func TestOpenAIEmbeddingProvider_EmbedBatchOrdering(t *testing.T) {
	...
	p := NewOpenAIEmbeddingProvider("sk-test", server.URL, "model", 1)
