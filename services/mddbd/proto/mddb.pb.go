...
const file_proto_mddb_proto_rawDesc = "" +
	...
	"\n" +
	"leader_lsn\x18\x02 \x01(\x04R\tleaderLsn2\x84\x0e\n" +
	"\x04MDDB\x12'\n" +
	...
	"\bClassify\x12\x15.mddb.ClassifyRequest\x1a\x16.mddb.ClassifyResponse2\xba\x02\n" +
...
var file_proto_mddb_proto_msgTypes = make([]protoimpl.MessageInfo, 90)
